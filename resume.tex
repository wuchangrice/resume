...
\newline Role: Member of Infrastructure Team in Intelligent Recommendation Platform
\begin{itemize}
  \item xxl-job , drools, tcpcopy, canel,es
  ...
  \item Reduced recall service timeout rate from 7.5‰ to 0.62‰ and made recall index update-time from 40 min to real-time.
\end{itemize}
...
\newline Role: Member of Pay Center Project
\begin{itemize}
